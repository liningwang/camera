...
import com.example.list.HorizontalScrollViewAdapter.ViewHolder;
...
//			mContainer = (LinearLayout) getChildAt(0);
	...
	public void initDatas(HorizontalScrollViewAdapter mAdapter)
	{
		...
		if (mChildWidth == 0 && mChildHeight == 0)
		{
			...
			mChildHeight = view.getMeasuredHeight();
			// 计算每次加载多少个View
			mCountOneScreen = (mScreenWitdh / mChildWidth == 0)?mScreenWitdh / mChildWidth + 1:mScreenWitdh / mChildWidth + 10;
...
public Bitmap getBitmapFromMemoryCache(String key) {  
 ...
 class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {  
	...
	private Bitmap downloadBitmap(String path) {
		return SDUtil.getImageforSize(path,mChildWidth,mChildHeight);
	}
}
	@Override
