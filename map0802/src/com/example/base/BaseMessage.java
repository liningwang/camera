...
public class BaseMessage {
	...
	public void setResult (String result) throws Exception {
		Log.d("wang","json format is " + result);
		...
		if (result.length() > 0) {
			...
			while (it.hasNext()) {
				...
				String modelClassName = "com.example.model." + modelName;
				Log.d("wang","model name is " + modelClassName);
				...
				// JSONArray
					...
					Log.d("wang","modename is " + modelName);
